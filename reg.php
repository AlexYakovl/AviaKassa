...
<main class="main">
    <div class="container">
        <h1 class="register-header">Регистрация</h1>
        <form action="auth.php?register=1" method="post" class="form" id="registerForm" enctype="multipart/form-data" >
            ...
            <input id="emailInput" class="unfilled form-input email-input" type="email" name="email" placeholder="test@email.ru" maxlength="148" required>
            ...
            <label for="nomer">Номер телефона</label>
            <input id="nomer" class="unfilled form-input phone-input" type="text"  name="phone" placeholder="+79225843481" required>
            <label for="picture" >Прикрепить паспорт</label>
            <input type="file" name="addfile" id="picture" >
        </form>
        <p class="login-para">Уже есть аккаунт? <a class="login-anchor" href="./login.php">Войти</a>.</p>
        <button form="registerForm" type="submit" class="register-btn" value="Verify" name="verify">Зарегистрироваться</button>
    </div>
</main>
</body>
</html>